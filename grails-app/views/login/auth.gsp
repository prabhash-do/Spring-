            ...
            <div class="card-body ">
                ...
                <form class="form-signin" action="${postUrl ?: '/login/authenticate'}" method="POST" id="loginForm" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <i id="passwordToggler" title="show password" onclick="passwordDisplayToggle()">&#128065;</i>
                    </div>
                    ...
                    <div class="form-group form-check">
                        <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="${rememberMeParameter ?: 'remember-me'}" id="remember_me" <g:if test='${hasCookie}'>checked="checked"</g:if>/><g:message code="springSecurity.login.remember.me.label"></g:message>
                        </label>
                    </div>
                        <button id="submit" class="btn btn-lg btn-primary btn-block text-uppercase" type="submit"><g:message code="springSecurity.login.button"></g:message></button>
                        <hr class="my-4">
                        <p><g:message code="springSecuirity.register.account">
                    </g:message><g:link controller="register"><g:message code="springSecurity.register.button"></g:message></g:link></p>
                </form>
            </div>
        </div>
    </div>
